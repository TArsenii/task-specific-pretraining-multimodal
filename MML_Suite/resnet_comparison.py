...
output_dir = Path('plots/avmnist/comparison/resnet')
...
def load_metrics_data(metrics_dir):
    ...
    Args:
        metrics_dir: Path to the metrics directory (e.g., "experiments_output/AVMNIST_ResNet_Training/metrics/1/")
    """
...
def main():
    ...
    experiment_dirs = [
        "experiments_output/AVMNIST_ResNet_Training/metrics/1/",
        "experiments_output/AVMNIST_ResNet_Pretrained_Training/metrics/1/"
    ]
    
    # Experiment names for legend
    experiment_labels = [
        "ResNet Standard Training",
        "ResNet with Pretrained Encoders"
    ]
