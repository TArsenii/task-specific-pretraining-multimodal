...
class LoggerSingleton:
    ...
    def configure(cls, log_path: str, log_level=logging.INFO, suffix: str = ""):
        if not cls._initialized:
            ...
            file_handler = logging.FileHandler(os.path.join(log_path, f"{suffix}_{cur_time}.log"))
...
def configure_logger(log_path, suffix: str = ""):
    LoggerSingleton.configure(log_path, suffix)
